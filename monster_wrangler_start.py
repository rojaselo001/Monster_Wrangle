...
class Game():
    ...
    def __init__(self, player, monster_group):
        ...
        # -- Sound --
        self.next_level_sound = Sound("next_level.wav")
    ...
    def draw(self):
        ...
        if collided_monster:
            ...
            if self.player.lives == 0:
                self.pause_game("GAME OVER", "Press Enter to play again")  # <-- replace with your code
                self.reset_game()
            else:
